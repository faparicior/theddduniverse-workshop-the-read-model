...
use Demo\App\Advertisements\AdvertisementStats\Application\Infrastructure\ReadModel\SqliteAdvertisementStatsViewRepository;
use Demo\App\Advertisements\AdvertisementStats\Application\Infrastructure\ReadModel\SqliteAdvertisementViewRepository;
...
class DependencyInjectionResolver
{
    ...
    {
        return new ApproveAdvertisementUseCase($this->advertisementRepository(), $this->securityService(), $this->transactionManager(), $this->eventBus());
    }
