...
class AdvertisementEventsProducer implements EventPublisher
{
    ...
    private function publishAdvertisementApproved(AdvertisementWasApproved $event): void
    {
    ...
    private function publishAdvertisementPublished(AdvertisementWasPublished $event): void
    {
